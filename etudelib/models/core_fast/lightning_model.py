...
from .torch_model import CORE_FASTModel

logger = logging.getLogger(__name__)
__all__ = ["CORE_FAST", "CORE_FASTLightning"]


class CORE_FAST(pl.LightningModule, ABC):
    def __init__(self,
                 embedding_size: int,
                 dnn_type: str,
                 sess_dropout: float,
        ...
        self.model = CORE_FASTModel(embedding_size,
                 dnn_type,
                 sess_dropout,
                 item_dropout,
                 temperature,
...
class CORE_FASTLightning(CORE_FAST):
    """Torch Lightning Module for the CORE_FAST model.
        Args:
