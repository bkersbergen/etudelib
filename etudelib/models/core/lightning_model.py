...
from .torch_model import COREModel

logger = logging.getLogger(__name__)
__all__ = ["CORE", "CORELightning"]


class CORE(pl.LightningModule, ABC):
    def __init__(self,
                 embedding_size: int,
                 dnn_type: str,
                 sess_dropout: float,
        ...
        self.model = COREModel(embedding_size,
                 dnn_type,
                 sess_dropout,
                 item_dropout,
                 temperature,
...
class CORELightning(CORE):
    """Torch Lightning Module for the CORE model.
        Args:
