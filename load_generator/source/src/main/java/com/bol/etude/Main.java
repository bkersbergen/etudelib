...
//        Option option1 = new Option("endpointId", true, "4775442882221834240");
        Option option1 = new Option("endpointId", true, "2765993023484461056");
        Option option2 = new Option("datasetLocation", true, "../dataset");
        Option option3 = new Option("datasetName", true, "bolcom25m_sample");
...
//        config.connectUri = String.format("http://127.0.0.1:7080/predictions/noop");
        ...
        LoadGenerator loadGenerator = new LoadGenerator.Builder()
                .withConfig(config)
                .withWarmup(RecboleInterDataProducer.class, trainingDataPath, duration, new RateLimitConfig(minRPS, targetPredictionsPerSecond))
                .withExperiment(RecboleInterDataProducer.class, testDataPath)
                .withCooldown(RecboleInterDataProducer.class, trainingDataPath, Duration.ofSeconds(1), new RateLimitConfig(targetPredictionsPerSecond, minRPS))
                .build();
        loadGenerator.run();
    }
