...
envsubst < ./unlink_endpoint_model_job.yaml > "/tmp/unlink_endpoint_model_job.${VERTEX_ENDPOINT_NAME_OR_ID}_${VERTEX_MODEL_ID/}.yaml"

kubectl --context bolcom-pro-default --namespace reco-analytics apply --namespace reco-analytics -f - < "/tmp/unlink_endpoint_model_job.${VERTEX_ENDPOINT_NAME_OR_ID}_${VERTEX_MODEL_ID/}.yaml"
