...
import com.bol.etude.dataproducer.SessiondataProducerTask;
...
public class LoadGenerator {
    ...
    private SessiondataProducerTask warmupDataProducerTask;
    ...
    private SessiondataProducerTask experimentDataProducerTask;
    private final ExecutorService experimentExecutorService = Executors.newFixedThreadPool(1);

    // COOLDOWN DATA PRODUCER
    private SessiondataProducerTask cooldownDataProducerTask;
    ...
    private void setWarmup(SessiondataProducerTask warmupDataProducerTask, Duration duration, RateLimitConfig warmupRatelimit) {
        this.warmupDataProducerTask = warmupDataProducerTask;
        this.warmupDuration = duration;
        this.warmupRatelimitConfig = warmupRatelimit;
    }

    private void setExperiment(SessiondataProducerTask experimentDataProducerTask) {
        this.experimentDataProducerTask = experimentDataProducerTask;
    }

    private void setCooldown(SessiondataProducerTask cooldownDataProducerTask, Duration duration, RateLimitConfig cooldownRatelimit) {
    ...
    public static class Builder {
        ...
        private SytheticDataProducer warmupDataProducerTask;
        private Duration warmupDuration;
        private RateLimitConfig warmupRatelimit;

        private SytheticDataProducer experimentDataProducerTask;


        private SytheticDataProducer cooldownDataProducerTask;
        private Duration cooldownDuration;
        private RateLimitConfig cooldownRatelimit;
        private LoadGeneratorConfig config;


        public Builder withWarmup(Class<SytheticDataProducer> dataProducerType, String trainingDataPath, Duration duration, RateLimitConfig rateLimitConfig) throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        public Builder withCooldown(Class<SytheticDataProducer> dataProducerType, String trainingDataPath, Duration duration, RateLimitConfig rateLimitConfig) throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
